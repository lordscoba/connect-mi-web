...
const Nav = () => {
  return (
    <div>
      ...
      <div className="flex justify-center space-x-8 p-4 items-center bg-white">
        ...
        <div className="flex bg-[#ffffff] w-1/3 items-center p-2 justify-around border-2 border-black rounded-xl">
          <IconContext.Provider value={{ size: "2rem" }}>
            <BiSearch />
          </IconContext.Provider>
          <input
